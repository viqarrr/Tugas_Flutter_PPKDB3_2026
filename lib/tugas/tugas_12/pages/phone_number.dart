...
class _PhoneNumberInputState extends State<PhoneNumberInput> {
  ...
  void _validateAndSubmit() {
    ...
    } else if (RegExp(r'[\,.]').hasMatch(widget.controller.text.trim())) {
      setState(() {
        _errorMessage =
            "Nomor telepon tidak boleh mengandung titik dan/ atau koma";
      });
    } else if (!RegExp(r'\d').hasMatch(widget.controller.text.trim())) {
      setState(() {
        _errorMessage = "Nomor telepon harus berupa angka";
      });
    } else {
      setState(() {
        _errorMessage = null;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Digunakan untuk masuk dan verifikasi.",
                    style: TextStyle(
                      fontSize: 16,
