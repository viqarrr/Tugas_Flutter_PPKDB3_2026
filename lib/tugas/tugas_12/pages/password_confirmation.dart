...
class _PasswordConfirmationInputState extends State<PasswordConfirmationInput> {
  ...
  void _validateAndSubmit() {
    if (passwordConfirmationC.text.trim().isEmpty) {
      setState(() {
        _errorMessage = "Konfirmasi password tidak boleh kosong";
      });
    } else if (passwordConfirmationC.text != widget.passwordC.text) {
      setState(() {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Masukkan kembali kata sandi yang sudah kamu buat sebelumnya.",
                    style: TextStyle(
                      fontSize: 16,
